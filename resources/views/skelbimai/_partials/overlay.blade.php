            ...
            <div class="col-md-12">
                ...
                <div class="row justify-content-center mb-4">
                    <div class="col-md-8 text-center">
                        ...
                        <p data-aos="fade-up" data-aos-delay="100">Geriausias skelbimų portalas</p>
                    </div>
                </div>
                            ...
                            <div class="col-lg-12 mb-4 mb-xl-0 col-xl-3">
                                <div class="select-wrap">
                                    ...
                                    <select class="form-control rounded" name="" id="">
                                        ...
                                        <option value="">Transporto priemonės</option>
                ...
                <div class="row text-left trending-search" data-aos="fade-up"  data-aos-delay="300">
                    <div class="col-12">
                        <h2 class="d-inline-block">Populiariausių paieška</h2>
                        <a href="#">iPhone</a>
                        <a href="#">Transporto priemonės</a>
                        <a href="#">Gėlės</a>
                        <a href="#">Namai</a>
                    </div>
                </div>
